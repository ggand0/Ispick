...
Component.infiniteScroll = (logging) ->
  console.log('Component.infiniteScroll called') if logging
  $('.pagination').hide()
  $(".wrap").infinitescroll({
...
Component.addDropdownEvents = () ->
  $('.dropdown-user').click (e) ->
    $("body").trigger("click")

Component.addModalEvents = () ->
